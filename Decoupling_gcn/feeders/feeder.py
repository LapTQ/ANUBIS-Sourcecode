...
class Feeder(Dataset):
    ...
    def load_data(self):
        ...
        print(f"标签文件加载成功，样本数量: {len(self.label)}")
        ...
        print(f"数据文件加载成功，数据形状: {self.data.shape}")
...
if __name__ == '__main__':
    ...
    data_path = "E:/val_data_all_action_back.npy"
    label_path = "E:/val_label_all_action_back.pkl"
    graph = 'graph.azure_kinect.Graph'
    test(data_path, label_path, graph=graph, is_3d=True)
