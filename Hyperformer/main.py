...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='Hyperformer/config/anubis.yaml',
            ...
            if not arg.train_feeder_args['debug']:
                ...
                if os.path.isdir(arg.model_saved_name):
                    ...
                    try:
                        ...
                        answer = 'y'
                        print('Running in non-interactive mode, automatically deleting existing log directory.')
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            with torch.amp.autocast('cuda', enabled=use_amp):
                ...
                output, z = self.model(data, F.one_hot(label, num_classes=num_class))
