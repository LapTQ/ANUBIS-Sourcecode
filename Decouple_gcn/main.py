...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='Decouple_gcn/config/anubis.yaml',
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help='whether to add one-hot encoding'
    )
    parser.add_argument(
        '--eval_start',
        type=int,
        default=0,
        help='start evaluating model from which epoch'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help='the interval between evaluations'
    )
    return parser
