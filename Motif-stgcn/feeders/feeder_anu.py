...
sys.path.append('E:/skletonbasedactionrecognition/code/Skeleton-Action-Recognition-master')
...
class Feeder(Dataset):
    ...
    def __len__(self):
        ...
        return min(32730, len(self.label))
    ...
    def __getitem__(self, index):
        ...
        if np.isnan(data_numpy).any() or np.isinf(data_numpy).any():
            print(f"在索引 {index} 处发现 NaN 或 Inf")
            # 处理无效值，例如用 0 替换
...
if __name__ == '__main__':
    ...
    data_path = "E:/skletonbasedactionrecognition/code/BlockGCN-main/data/anubis/val_data_all_action_back.npy"
    label_path = "E:/skletonbasedactionrecognition/code/BlockGCN-main/data/anubis/val_label_all_action_back.pkl"
    graph = 'graph.azure_kinect'
