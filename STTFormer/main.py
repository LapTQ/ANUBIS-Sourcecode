...
def get_parser():
    ...
    parser.add_argument('--work_dir', default='./work_dir/anubis/temp', help='the work folder for storing results')
    parser.add_argument('--config', default='STTFormer/config/anubis/anubis.yaml', help='path to the configuration file')
