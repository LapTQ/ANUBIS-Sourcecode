...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='config/gcn-nas/anubis.yaml',#./config/nturgbd-cross-view/test_bone.yaml
    ...
    parser.add_argument(
        '--weights',
        default='',#./runs/ntu_cv_agcn_joint_Re-49-23500.pt #ntu_cv_agcn_joint_Re2_w64-69-21761.pt  
