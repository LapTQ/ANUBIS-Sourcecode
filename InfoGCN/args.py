...
def get_parser():
    ...
    parser.add_argument('--num_point', type=int, default=32, help='')
    parser.add_argument('--num_person', type=int, default=2, help='')
    parser.add_argument('--num_class', type=int, default=102, help='')
    parser.add_argument('--dataset', default='anubis', help='data loader will be used')
    parser.add_argument('--datacase', default='CS', help='data loader will be used')
    parser.add_argument('--use_vel', type=str2bool, default=True, help='')
    ...
    # feeder
    parser.add_argument('--feeder', default='feeders.feeder_anubis.Feeder', help='data loader will be used')
    ...
    parser.add_argument('--graph', type=str, default='graph.anubis.Graph', help='')

    # optim
    parser.add_argument('--base_lr', type=float, default=0.001, help='initial learning rate')
    parser.add_argument('--step', type=int, default=[30], nargs='+', help='the epoch where optimizer reduce the learning rate')
